                                    ...
                                    <tbody>
                                       @foreach ($data as $key=>$d)
                                            <tr>
                                                ...
                                                <td>
                                                    <form action="{{route('admin.withdrawl1',['id'=>$id])}}" method="post">
                                                        @csrf
                                                        @foreach ($d as $dd)
                                                        <input name="ids[]" type="hidden" value="{{$dd->id}}"/>
                                                        @endforeach
                                                        <input type="hidden" name="date" value="{{$key}}"/>
                                                        <input type="hidden" name="amount" value="{{$d->sum('vendoramount')}}"/>
                                                        <input type="submit" value="Withdraw" class="btn btn-submit">
                                                    </form>
                                                </td>
                                            </tr>
                                                ...
                                                <td>
                                                    @foreach ($attributes as $attr)
                                                        <div>
                                                            ...
                                                            @if(!empty($withdrawl->paymentdetails[$attr]))
