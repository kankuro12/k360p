...
<div class="col-md-10 col-md-offset-1">
    ...
    <div class="card">
        ...
        <div class="card-content">
            ...
            <form action="{{ route('admin.savewithdrawl1',['id'=>$account->vendor->id]) }}" enctype="multipart/form-data" method="post">
            @csrf
            @foreach ($all['ids'] as $i)
            ...
            @endforeach
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <input class="form-control" value="{{$all['amount']}}" required readonly type="number" name="amount" id="amount" required>
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        @if($attribute=="Order_Date")
                            <input class="form-control" required readonly type="text" name="{{$attribute}}" id="{{$attribute}}" value="{{$all['date']}}">
