            ...
            <div class="card">
                ...
                <div class="card-content">
                    <h4 class="card-title">
                        ...
                        /
                        @if ($category->parentlists!="")
                        {!!$category->parentlists!!} 
                    ...
                    <div class="toolbar">
                        <button class="btn btn-primary create_modal" >Add SubCateogry</button>
                    </div>
                    ...
                    <div class="col-md-8">
                            ...
                            <div class=" pr-md-1">
                                <div class="form-group label-floating">
                                    ...
                                    <input type="number" min="0" class="form-control"  name="referal_charge" >
                                </div>
                            </div>
