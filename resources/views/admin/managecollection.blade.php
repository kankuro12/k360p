                        ...
                        <table id="datatables" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
                            ...
                            <tbody>
                                ...
                                <tr class="collection{{ $collection->collection_id }}">
                                    ...
                                    <td class="text-center"> <img src="{{ asset( $collection->collection_image) }}" style="max-width: 100px;" alt=""> </td>
                                    <td class="text-center">{{ Str::limit($collection->collection_description, 100)  }}</td>
                                    <td class="text-center">
                                        ...
                                        <a  href="{{route('admin.edit-collection-products',['id'=>$collection->collection_id])}}" data-toggle="tooltip" data-placement="left" title="Manage" class=" btn btn-just-icon btn-round btn-success" ><i class="material-icons">assignment</i></a>
                    ...
                    <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                        ...
                        <div>
                            <span class="btn btn-rose btn-round btn-file">
                                ...
                                <input accept="image/*" type="file" name="collection_image" id="collection_image" />
                            </span>
                    ...
                    <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                        ...
                        <div>
                            <span class="btn btn-rose btn-round btn-file">
                                <span class="fileinput-new">Select image</span>
                                <span class="fileinput-exists">Change</span>
                                <input accept="image/*" type="file" name="collection_image" id="collection_image1" />
                            </span>
                            <a href="#pablo" class="btn btn-danger btn-round fileinput-exists" data-dismiss="fileinput"><i class="fa fa-times"></i> Remove</a>
                        </div>
                    </div>
