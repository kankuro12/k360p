        ...
        <div class="col-sm-12 col-sm-offset-0">
            ...
            <div class="card">
                ...
                <div class="card-content">
                    ...
                    <div class="toolbar">
                        <a href="{{route('admin.pickup-pickup')}}" class="btn btn-primary">Item In WareHouse</a>
                    </div>
...
@section('scripts')
    <script>
        ...
        function query(id) {
            var statusurl = '/admin/orders/data/pickup/load';
        ...
        function pickup(id) {
            var statusurl = '/admin/orders/data/pickup/pickup';
