...
<head>
    ...
    @include('delivery.layout.onesignal')
                ...
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand"
                            href="{{ route('delivery.dashboard') }}">{{ Auth::user()->point->name }}'s Dashboard </a>
                    </div>
...
<script src="{{ asset('js/backend-js/perfect-scrollbar.jquery.min.js') }}"
