...
@if ($cat != null)
    ...
    <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow cat-owl" >
@foreach ($products as $product)
    ...
    <div class="product text-center">
        <figure class="product-media">
            ...
            <div class="product-action text-center">
                ...
                <form action="{{ route('public.cart') }}" method="POST" class="w-100">
                    ...
                    @else
                       <a href="{{ route('product.detail',$product->product_id) }}" class="btn-product btn-cart "><span>View Detail</span></a>
                    @endif
        ...
        <div class="product-body">
            ...
            <h3 class="product-title"><a href="/product/{{$product->id}}">{{$product->product_name}}</a></h3>
            <!-- End .product-title -->
