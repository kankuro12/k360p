            ...
            <div class="col-xl-9 col-xxl-10">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('themes/molla/assets/images/demos/demo-14/banners/banner-2.jpg') }}"
                                            alt="Banner img desc">
                                    </a>
                            ...
                            <div class="col-md-6">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('themes/molla/assets/images/demos/demo-14/banners/banner-3.png') }}"
                                            alt="Banner img desc">
                                    </a>
                    ...
                    <div class="col-12 col-xxl-5col d-none d-xxl-block">
                        <div class="banner banner-overlay">
                            <a href="#">
                                <img src="{{ asset('themes/molla/assets/images/demos/demo-14/banners/banner-4.jpg') }}"
                                    alt="Banner img desc">
                            </a>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="banner banner-overlay">
                            <a href="#">
                                <img src="{{ asset('themes/molla/assets/images/demos/demo-14/banners/banner-7.jpg') }}"
                                    alt="Banner img desc">
                            </a>
                    ...
                    <div class="col-md-6">
                        <div class="banner banner-overlay">
                            <a href="#">
                                <img src="{{ asset('themes/molla/assets/images/demos/demo-14/banners/banner-8.jpg') }}"
                                    alt="Banner img desc">
                            </a>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xl-12">
                            <div class="widget widget-banner">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('themes/molla/assets/images/demos/demo-14/banners/banner-11.jpg') }}"
                                            alt="Banner img desc">
                                    </a>
                        ...
                        <div class="col-sm-6 col-xl-12">
                            <div class="widget widget-banner">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('themes/molla/assets/images/demos/demo-14/banners/banner-12.jpg') }}"
                                            alt="Banner img desc">
                                    </a>
