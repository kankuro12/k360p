                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="product-gallery">
                                            ...
                                            @php 
                                                $p_image = \App\model\admin\Product_image::where('product_id',$product->product_id)->get();
                                            @endphp
                                            <div id="product-zoom-gallery" class="product-image-gallery">
                                                <a class="product-gallery-item active" href="#" data-image="{{ asset($product->product_images) }}" data-zoom-image="{{ asset($product->product_images) }}">
                                        ...
                                        <div class="product-details product-details-sidebar">
                                            ...
                                            <div class="details-filter-row details-row-size">
                                                ...
                                                <div class="select-custom">
                                                    <select data-role="variant" data-id="{{$variant->id}}"  class="form-control" name="attribute_{{$variant->id}}" id="attribute_{{$variant->id}}" required>
                                            ...
                                            <div class="product-details-action" id="product-details-action">
                                                ...
                                                <div class="details-action-col">
                                                    ...
                                                    <div class="product-details-quantity">
                                                        <input max="{{$product->quantity}}" min="1" type="number" id="qty" name="qty" class="form-control" value="1" min="1" max="10" step="1" data-decimals="0" required>
                            ...
                            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                ...
                                <div class="product product-7 text-center">
                                    <figure class="product-media">
                                        ...
                                        <a href="product.html">
                                            <img src="{{ asset('themes/molla/assets/images/products/product-4.jpg') }}" alt="Product image" class="product-image">
                                        </a>
                            ...
                            <div class="sidebar sidebar-product">
                                ...
                                <div class="widget widget-banner-sidebar">
                                    ...
                                    <div class="banner-sidebar banner-overlay">
                                        <a href="#">
                                            <img src="{{ asset('themes/molla/assets/images/blog/sidebar/banner.jpg') }}" alt="banner">
                                        </a>
                                    </div><!-- End .banner-ad -->
                                </div><!-- End .widget -->
        ...
        $('[data-role="variant"]').change(function(){
            ...
            axios.post("{{url('product/stock/get')}}",data)
                .then(function (response) {
                    ...
                    if(innerdata.sucess){
                        html=' <div class="details-action-col"><label for="qty">Qty:</label><div class="product-details-quantity"><input max="'+innerdata.data.qty+'" min="1" type="number" id="qty" name="qty" class="form-control" value="1" min="1" max="10" step="1" data-decimals="0" required></div><button class="btn-product btn-cart"><span>add to cart</span></button></div>';
